...
signal reg_address_internal : std_logic;
...
port map(
    ...
    reg_address => reg_address_internal,
...
port map(
    ...
    reg_write_address <= to_unsigned((2 ** reg_address_bits) - 1, reg_address_bits) when jump_internal = '1' and reg_write_enable_internal = '1' -- jal
                else instruction(r3_pos-1 downto r3_pos-reg_address_bits) when reg_address_internal = '1'
